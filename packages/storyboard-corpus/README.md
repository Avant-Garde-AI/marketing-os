...
plus a local v2 manifest with cache paths. The source prefix must be private:
...
now include complete three-, six-, and ten-slide carousels alongside three singles.
