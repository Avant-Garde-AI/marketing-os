...
# Manage the Marketing OS agent (Next.js + Mastra) from the project root.
#
# Usage:
...
SCRIPTS_DIR="${ROOT_DIR}/scripts/agents"
...
${YELLOW}EXAMPLES${NC}
  ...
  ./agents.sh deploy:preview          # preview deployment

${YELLOW}ADDING COMMANDS${NC}
  Drop a script in ${BLUE}scripts/agents/<namespace>/<command>.sh${NC}
  It will be available as ${BLUE}./agents.sh <namespace>:<command>${NC}
...
# Export common vars so subscripts can use them
